...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-amber-800 via-green-900 to-amber-800 text-green-100 pt-20 pb-12 mt-24 border-t border-green-700 shadow-2xl relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-12 gap-x-10">
          ...
          <div className="space-y-5 flex flex-col justify-between">
            <div>
              ...
              <Link to="/" className="text-5xl font-playfair-display font-extrabold tracking-wide text-green-50 cursor-pointer hover:text-green-200 transition-colors duration-300">
                FC Herbal
              </Link>
              <p className="text-base font-inter mt-4 max-w-sm leading-relaxed text-green-200 opacity-90">
                Crafted with nature's purest essence. Elevating wellness through authentic herbal products.
              </p>
            </div>
            {/* Newsletter Subscription */}
            <div className="mt-8">
              <h3 className="font-semibold text-xl mb-4 font-inter tracking-wide text-green-50">
                Stay Updated
              </h3>
              <form className="flex">
                <input
                  ...
                  className="flex-grow p-3 rounded-l-md bg-green-700 border border-green-600 placeholder-green-300 text-green-50 focus:outline-none focus:ring-2 focus:ring-green-400 transition-all duration-300"
                />
                <button
                  type="submit"
                  className="bg-lime-500 text-green-950 font-semibold px-5 rounded-r-md hover:bg-lime-400 transition-colors duration-300 transform hover:scale-105"
                >
                  Subscribe
                </button>
              </form>
          ...
          {/* Navigation */}
          <nav>
            <h3 className="font-semibold text-xl mb-6 font-inter tracking-wide text-green-50">
              Explore
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-base font-inter max-w-xs text-green-200 opacity-90">
              <li>
                Email:{" "}
                <a
              ...
              <li className="pt-2">
                {/* Using Link component for internal navigation */}
                <Link to="/contact" className="inline-block bg-lime-600 text-green-950 px-6 py-2 rounded-full font-semibold text-sm hover:bg-lime-500 transition-colors duration-300 transform hover:-translate-y-0.5">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-6 text-green-300 items-center">
              {[
                {
                  icon: <FaInstagram />,
                ...
                <a
                  ...
                  aria-label={label}
                  className="text-3xl hover:text-lime-400 transition-all duration-300 transform hover:scale-125 hover:rotate-6"
                >
                  {icon}
                </a>
              ))}
        ...
        {/* Bottom */}
        <div className="mt-16 border-t border-green-700 pt-8 flex flex-col sm:flex-row justify-between items-center text-sm text-green-200 font-inter space-y-4 sm:space-y-0">
